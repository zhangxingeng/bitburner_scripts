...
(the actual autonomous gameplay entry point). See `docs/mcp/mcp-control-channel-usage.md` §0.
...
was true before the WebSocket control channel was built (`docs/mcp/plan-mcp-realtime-control.md`).
...
`docs/mcp/mcp-control-channel-usage.md` for the full picture — that doc is the canonical, current

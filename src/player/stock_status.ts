...
/**
 * Stock manager (docs/design/11) — STUB. Wave 1 replaces the body.
 *
 ...
 *
 * Reference: STATUS SHIM: report on the bootstrap-launched /stock/main.js engine; do not relaunch it.
 */

...
/**
 * Bladeburner manager (docs/design/11) — STUB. Wave 1 replaces the body.
 *
 ...
 *
 * Reference: ref example_code_dump/alainbryden-bitburner-scripts/bladeburner.js.
 */
export async function main(ns: NS): Promise<void> {
	...
	while (true) {
		saveSubsystem(ns, {
			...
			enabled: true,
			running: false,
			headline: 'Bladeburner — pending Wave 1',
			metrics: {},
			ts: Date.now(),
		});

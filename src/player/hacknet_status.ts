...
/**
 * Hacknet manager (docs/design/11) — STUB. Wave 1 replaces the body.
 *
 ...
 *
 * Reference: STATUS SHIM: report on the bootstrap-launched hacknet engine; do not relaunch it.
 */
export async function main(ns: NS): Promise<void> {
	...
	while (true) {
		saveSubsystem(ns, {
			...
			enabled: true,
			running: false,
			headline: 'Hacknet — pending Wave 1',
			metrics: {},
			ts: Date.now(),
		});
